      ...
      <StyledContainer>
        <StyledSection id="about">
          ...
          <p>
            ...
            town). I attended html summer camps at Stanford as a kid and always
            had a computer at home. Attended college in San Francisco, and was
            tweaking some basic websites for friends and social networks. I
            moved to NYC to be closer to family after college.
          </p>
          <p>
          ...
          <p>
            In 2015, I was getting tired of consuming so many websites and apps
            and kept seeing the limitations of the app or places where I wanted
            to tweak the app. Some times a small part of the design or other
            times want to add more robust features or want to even totally redo
            the app entirely. I wanted to really start creating and
